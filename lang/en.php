...
$string["mediahub"][8] = 'Click or drag document';
...
$string[8][83] = 'Display name'; // Input name
...
$string[16][41] = 'ID'; // Headline
$string[16][42] = 'Email'; // Headline
$string[16][43] = 'Price'; // Headline
$string[16][44] = 'Date'; // Headline
$string[16][45] = 'Activity'; // Headline
$string[16][46] = 'Payment expected. Product already picked up.'; // Pickup states title
$string[16][47] = 'Payment expected.'; // Pickup states title
$string[16][48] = 'Pick up expected'; // Pickup states title
$string[16][49] = 'Picked up'; // Pickup states title
$string[16][50] = 'View transaction'; // Link title
$string[16][51] = 'Remove transaction'; // Link title
$string[16][52] = 'Last'; // Footer nav
$string[16][53] = 'Next'; // Footer nav

$string[16][54] = 'The transaction <strong>%email% (#%id%)</strong> was deleted <strong>successfully</strong>.'; // Remove message success
$string[16][55] = 'The transaction <strong>%email% (#%id%)</strong> could <strong>not</strong> be deleted.'; // Remove message fail
$string[16][56] = 'You have <strong>no authorization</strong> to perform this action'; // No access
