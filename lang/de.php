...
$string[16][43] = 'Preis'; // Headline
$string[16][44] = 'Datum'; // Headline
$string[16][45] = 'Aktion'; // Headline
$string[16][46] = 'Zahlung erwartet. Produkte bereits abgeholt.'; // Pickup states title
$string[16][47] = 'Zahlung erwartet.'; // Pickup states title
$string[16][48] = 'Abholung erwartet'; // Pickup states title
$string[16][49] = 'Abgeholt'; // Pickup states title
$string[16][50] = 'Transaktion anzeigen'; // Link title
$string[16][51] = 'Transaktion entfernen'; // Link title
$string[16][52] = 'Zurück'; // Footer nav
$string[16][53] = 'Weiter'; // Footer nav

$string[16][54] = 'Die Transaktion <strong>%email% (#%id%)</strong> wurde <strong>erfolgreich</strong> gelöscht.'; // Remove message success
$string[16][55] = 'Die Transaktion <strong>%email% (#%id%)</strong> konnte <strong>nicht</strong> gelöscht werden.'; // Remove message fail
$string[16][56] = 'Sie haben <strong>keine Berechtigung</strong> um diese Aktion durchzuführen'; // No access
